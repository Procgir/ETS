...
using ElectronicTestSystem.ConsoleAppV2;
...
new CalculateMarkApp(
 new MarkCalculatorFacade(
  ...
  new TestService(new TestsFileRepository(FileRepositoriesFileNames.Tests, new TestConverter()), null), //TODO: добавить UoW
